...
<head>
	...
	<link rel="stylesheet" href="css/skins/{$skin}.css?v=2.0" id="window-skin">
</head>
...
<div id="desktop">
	<div id="zoom-tip">
		...
		<a href="javascript:;" class="close" onClick="HROS.zoom.close();">×</a>
	</div>
	<div id="desk">
...
<script src="js/core.js?v=2.0"></script>
{literal}
<script>
$().ready(function(){
	//IE下禁止选中
	...
	art.dialog({
		...
		icon: 'face-smile',
		width: 320,
		content:'HoorayOS是否就是你一直想要的web桌面么？<br>' + 
						'那么我非常期待您能够热情的提供<font style="color:red">35元</font>或者其他金额的捐赠鼓励，正如您支持其他开源项目一样。<br>' + 
						'支付宝：<a href="https://me.alipay.com/hooray" style="color:#214FA3" target="_blank">https://me.alipay.com/hooray</a><div style="width:100%;height:0px;font-size:0;border-bottom:1px solid #ccc"></div>如果你对本框架感兴趣，欢迎加入讨论群：<br>213804727' + 
						'<div style="width:100%;height:0px;font-size:0;border-bottom:1px solid #ccc"></div>' +
