...
//require_once('..' . DIRECTORY_SEPARATOR . 'libs'. DIRECTORY_SEPARATOR . 'functions' . DIRECTORY_SEPARATOR . 'configCheck.php');
...
<p><?php echo $_SESSION['app_name']?> will carry out a number of checks to see if everything's ready to start 
	the installation.</p>
<table>
...
?>
	<p>Unfortunately, <?php echo $_SESSION['app_name']?> scripted setup cannot continue at the moment, due to the above 
...
?>
	...
	<div>
	<p class="success">Your system is prepared for <?php echo $_SESSION['app_name']?> configuration (no fatal problem found).</p>
	</div>
</div>
<?php 
